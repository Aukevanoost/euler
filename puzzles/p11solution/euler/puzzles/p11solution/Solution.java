package euler.puzzles.p11solution;

import euler.puzzles.p11solution.strategy.*;
...
public class Solution implements IPuzzle {
    public String explain() {
        return "What is the greatest product of four adjacent numbers in the same direction (up, down, left, right, or diagonally) in the 20×20 grid?";
    }
    ...
    public Supplier<String> solve() {
        return () -> {
            ...
            return String.valueOf(strat.run(input));
        };
    }
